...
export const ContextApi = createContext(); //creating the space for context //useSate for storing the values

export const Contextdata = (props) => {  /// only name eport component needed
